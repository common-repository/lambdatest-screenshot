...
?>
    <div class="main-section" id="lt_src_app">
        <template>
            <div class="error_msg" :class="{ display_none: concurrency_error_msg === ''}">
            ...
            <div class="_main_container_" @mouseover.once="updateUrl()">
                <div class="col-xs-12 padding-zero native-tab-sec">
                    ...
                    <div class="col-xs-5" style="padding: 0px;">
                        <input type="text" placeholder="Place your URL Here" class="search-input" name="txtUrl" value="" v-model="txtUrl" @keyup="getAutoSuggestion()">
                    ...
                    <div class="col-xs-9">
                        <ul class="tab-device" role="tablist">
                            <li class="active">
                                ...
                                <img class="cursor-pointer" width="30" src="<?php echo plugins_url( 'icons/desktop.png', __FILE__ ); ?>">
                                </a>
                            </li>
                            <li >
                                <a href="#lt_scr_mobile" role="tab" data-toggle="tab">
                                <img class="cursor-pointer" width="20" src="<?php echo plugins_url( 'icons/mobile.png', __FILE__ ); ?>">
                                </a>
                            </li>
                            <li class="list_select">
                                <img class="cursor-pointer" @click="clearConfig()" width="20" src="<?php echo plugins_url( 'icons/reset.svg', __FILE__ ); ?>"> &nbsp; <span v-text="total_count"></span>/25 Selected
                            </li>
                            <li >
                                <div class="cursor-pointer cursor-setting" style="font-size: 20px;" width="20"  id="preference_setting"><img class="cursor-pointer" width="20" src="<?php echo plugins_url( 'icons/settings.svg', __FILE__ ); ?>"></div>
                                <div class="setting-price">
                                    <div class="setting-overlay" @click="hideSettingPopup()">
                                    </div>
                                    <div class="setting-popup-container">
                                        <div class="popupContent padding30">
                                            ...
                                            <div class="formControl">
                                                ...
                                                <label class="switch" for="chunkType">
                                                    <input type="checkbox" id="chunkType" v-model="is_smart_scroll"/>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="lt_scr_desktop">
                            ...
                            <div class="tab-content desktop_content" >
                                ...
                                <div v-for="(browser,index) in desktop.browsers" :key="index" v-if="browser.count > 0" role="tabpanel" class="tab-pane" :class="{ active: index === 0 }" :id="getTabRef('',browser.image)">
                                    ...
                                    <div class="browsers-ver-main col-xs-12">
                                    <div class="col-xs-12 browsers-ver-sec" v-for="(desktop_browser,desk_index) in desktop.desktop" :key="desk_index" v-if="desktop_browser.versions[browser.name].length > 0">
                                        <div class="col-xs-2">                                       
                                            <div class="os_all" :id="browser.browser_id+'_'+desktop_browser.os_version_id"><span class="list-os-tab"><img class="os_icon" :src="getImgUrl('<?php echo plugins_url( 'icons/', __FILE__ ); ?>',desktop_browser.name.toLowerCase().split(' ')[0],null,'.svg')"></span><span>{{desktop_browser.name}}</span></div>
                                        </div>
                                        <div class="col-xs-4" data-mcs-theme="dark">
                                            <ul class="browsers-ver-list">
                                                <li :id="browser.browser_id+'_'+desktop_browser.os_version_id+'_'+desktop_browser_version.browser_version_id" v-for="(desktop_browser_version,desk_ver_index) in desktop_browser.versions[browser.name]" :key="desk_ver_index" @click="setDesktopConf(desktop_browser.os_version_id,desktop_browser_version.browser_id,desktop_browser_version.browser_version_id,desktop_browser.name.includes('Win') ? win_res:mac_res, desktop_browser.name)" :class="desk_ver_index > 10 ? browser.browser_id+'_'+desktop_browser.os_version_id + ' display_none':''">
                                                    {{desktop_browser_version.version_no}}
                                                </li>
                                                <li :id="'more_less_'+browser.browser_id+'_'+desktop_browser.os_version_id" style="color: #0ebac5;cursor: pointer;" :class="{ display_none: desktop_browser.versions[browser.name].length <= 10}" @click="showMore(browser.browser_id+'_'+desktop_browser.os_version_id)">more..</li>
                                            </ul>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="browsers-ver-main col-xs-12">
                                    <div class="col-xs-12 browsers-ver-sec" v-for="(mobile_ele,index) in mobile.android" :key="index">
                                        ...
                                        <div class="col-xs-5"  data-mcs-theme="dark">
                                            <ul class="version-list">
                                                ...
                                                <li :id="'more_less_'+mobile_ele.manufacturer_id" style="color: #0ebac5;cursor: pointer;" :class="{ display_none: mobile_ele.devices.length <= 5}" @click="showMore(mobile_ele.manufacturer_id)">more..</li>
                                            </ul>
                                        </div>
                                    </div>
                                    </div>  
                                    ...
                                    <div class="col-xs-12 browsers-ver-sec" v-for="(mobile_ele,index) in mobile.ios" :key="index">
                                        ...
                                        <div class="col-xs-5"  data-mcs-theme="dark">
                                            <ul class="version-list">
                                                ...
                                                <li :id="'more_less_'+mobile_ele.os_version_id" style="color: #0ebac5;cursor: pointer;" :class="{ display_none: mobile_ele.devices.length <= 5}" @click="showMore(mobile_ele.os_version_id)">more..</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>  
            ...
            <script>
                ...
                var lt_src_app = new Vue({
                    ...
                    methods: {
                        ...
                        getDesktop : function(){
                            axios.get(`https://app.lambdatest.com/assets/launchers/screenshot-desktop.json`)
                        ...
                        getMobile : function(){
                            axios.get(`https://app.lambdatest.com/assets/launchers/screenshot-mobile.json`)
                            .then(function (response) {
                        ...
                        setDesktopConf:function(os_version_id,browser_id,browser_version_id,resolution_id, browser_name){
                                ...
                                if(this.isUrlValid(this.myDefaultConf.url)){
                                    ...
                                    this.configs.forEach(element => {
                                        if ( element.browser_name ) {
                                           element.resolution_id = element.browser_name.includes("Win") ? this.win_res : this.mac_res;
                                           delete element.browser_name;
                                        }
                                        delete element.manufacturer_id;
                                    });

                                    axios.post('<?php echo $lt_falcon_url;?>/screenshots/start', this.myDefaultConf,{
                                        headers: {
                                            "Content-type": "application/json",
                                            "Authorization": `Basic ${btoa(localStorage.getItem('lt_user_name')+':'+localStorage.getItem('lt_scr_access_token'))}`
                                        }
                                    }).then(function (response) {
                                        ...
                                        // Show error msg and hide it after 3 sec.
                                        // --------------
                                        if ( response.data.type === "error" ) {
                                            this.concurrency_error_msg = response.data.message;
                                            this.main_loader_is_active = false;
                                            let timeoutId = setTimeout(() => {
                                                this.concurrency_error_msg = "";
                                            }, 3000);
                                            if ( this.concurrency_error_msg === "" ) {
                    ...
                    computed: {
                        myDefaultConf(){
                            return {
                                ...
                                chunkType: this.is_smart_scroll ? "multi" : "single",
                                url: this.txtUrl,
                                email: this.email,
