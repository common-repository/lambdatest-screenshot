                ...
                var ltScrTestlogApp = new Vue({
                    ...
                    methods: {
                        ...
                        getTestLogs:function(){
                            this.is_loader_active = true;
                            if(localStorage.getItem('lt_scr_access_token')){
                                axios.get(`https://manual-api.lambdatest.com/screenshots/user-tests/screenshot?limit=${this.limit}&offset=${this.offset}`, {
                                    headers: {
                        ...
                        getScreenshots:function (test_id){
                            ...
                            axios.get(`<?php echo $lt_falcon_url;?>/screenshots/${test_id}/screenshots`,{
                                headers: {
